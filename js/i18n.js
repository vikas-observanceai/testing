...
(function () {
  ...
  var translations = {
    en: {
      ...
      /* Voting page */
      'voting-badge-label':     'ELECTIONS NB · APRIL 20, 2026',
      'voting-title':           'Voting Starts Today!',
      'voting-subtitle':        'Early voting is open at all 18 municipal returning offices across Fredericton.',
      'voting-offices-label':   '18 Municipal Returning Offices',
      'voting-offices-sub':     'Open now for early in-person voting',
      'voting-mail-label':      'Vote by Mail Available',
      'voting-mail-sub':        'Apply online or at your returning office · Must be returned by 8 p.m. on election day',
      'voting-access-label':    'Accessible Voting',
      'voting-access-sub':      'Braille controller, sip &amp; puff systems, and audio session paddles available at all offices',
      'voting-body-1':          'People who wish to cast ballots for the May 11 local government, rural district and district education council elections can do so at any of the 18 municipal returning offices now open for these elections.',
      'voting-body-2':          '"This voting option offers greater flexibility to voters who might not otherwise be able to cast their vote during the scheduled voting times," said Kim Poffenroth, municipal electoral officer. "Electors who are away from their normal voting place can also go to any returning office to request a ballot for the place where they are eligible to vote."',
      'voting-body-3':          'Poffenroth noted that, with printed ballots now available, the municipal returning offices will start processing the requests received for mail-in ballots. Electors can continue to apply for a vote-by-mail package either by using the online portal on the Elections NB website, or by downloading an application and submitting it to their local returning office.',
      'voting-note':            '<strong>Note:</strong> All mail-in ballots must be returned to the returning office from where they were issued before 8 p.m. on election day.',
      'voting-advance-heading': 'Advance Polling Station',
      'voting-advance-intro':   'You can vote between <strong>10:00 a.m. and 8:00 p.m.</strong> on either advance polling day:',
      'voting-date-1':          'Saturday, May 2, 2026',
      'voting-time-1':          '10:00 a.m. – 8:00 p.m.',
      'voting-date-2':          'Monday, May 4, 2026',
      'voting-time-2':          '10:00 a.m. – 8:00 p.m.',
      'voting-venue-label':     'Paroisse Ste-Anne-des-Pays-Bas',
      'voting-venue-addr':      '655 rue Priestman St, Fredericton, NB',
      'voting-callout':         'Every vote counts. Whether you vote early, by mail, or on Election Day — <strong>May 11, 2026</strong> — your voice shapes Ward 7\'s future. Vote Manisha Varma for a Dedicated · Inclusive · Trusted councillor.',
      'voting-map-title':       'Advance Polling Location',
      'voting-map-sub':         'Paroisse Ste-Anne-des-Pays-Bas<br/>655 rue Priestman St, Fredericton, NB',
      'voting-map-btn':         'Open in Google Maps',
      'voting-eday-title':      'Election Day',
      'voting-eday-date':       'Monday, May 11, 2026',
      'voting-eday-sub':        'Regular polling stations open',
      'voting-eday-find':       'Not sure where to vote?',
      'voting-eday-find-sub':   'Visit electionsnb.ca to find your polling station',
    },
    fr: {
      /* Top banner */
      ...
      /* Voting page */
      'voting-badge-label':     'ÉLECTIONS N.-B. · 20 AVRIL 2026',
      'voting-title':           'Le vote commence aujourd\'hui!',
      'voting-subtitle':        'Le vote anticipé est ouvert dans les 18 bureaux de directeur du scrutin municipal à travers Fredericton.',
      'voting-offices-label':   '18 bureaux de directeur du scrutin municipal',
      'voting-offices-sub':     'Ouverts maintenant pour le vote en personne anticipé',
      'voting-mail-label':      'Vote par correspondance disponible',
      'voting-mail-sub':        'Faites une demande en ligne ou à votre bureau de directeur du scrutin · Doit être retourné avant 20 h le jour des élections',
      'voting-access-label':    'Vote accessible',
      'voting-access-sub':      'Contrôleur en braille, systèmes de sifflement et pagaies de session audio disponibles dans tous les bureaux',
      'voting-body-1':          'Les personnes qui souhaitent voter pour les élections municipales, de district rural et de conseil d\'éducation de district du 11 mai peuvent le faire dans l\'un des 18 bureaux de directeur du scrutin municipal maintenant ouverts pour ces élections.',
      'voting-body-2':          '« Cette option de vote offre une plus grande flexibilité aux électeurs qui ne pourraient autrement pas voter pendant les heures de scrutin prévues », a déclaré Kim Poffenroth, directrice électorale municipale. « Les électeurs qui se trouvent à l\'extérieur de leur lieu de vote habituel peuvent également se rendre à n\'importe quel bureau de directeur du scrutin pour demander un bulletin de vote pour l\'endroit où ils sont admissibles à voter. »',
      'voting-body-3':          'Mme Poffenroth a noté que, les bulletins de vote imprimés étant maintenant disponibles, les bureaux de directeur du scrutin municipal commenceront à traiter les demandes reçues pour les bulletins de vote par correspondance. Les électeurs peuvent continuer à faire une demande de trousse de vote par correspondance soit en utilisant le portail en ligne sur le site web d\'Élections NB, soit en téléchargeant une demande et en la soumettant à leur bureau de directeur du scrutin local.',
      'voting-note':            '<strong>Remarque :</strong> Tous les bulletins de vote par correspondance doivent être retournés au bureau de directeur du scrutin d\'où ils ont été émis avant 20 h le jour des élections.',
      'voting-advance-heading': 'Bureau de vote par anticipation',
      'voting-advance-intro':   'Vous pouvez voter entre <strong>10 h et 20 h</strong> l\'un ou l\'autre des jours de vote par anticipation :',
      'voting-date-1':          'Samedi 2 mai 2026',
      'voting-time-1':          '10 h – 20 h',
      'voting-date-2':          'Lundi 4 mai 2026',
      'voting-time-2':          '10 h – 20 h',
      'voting-venue-label':     'Paroisse Ste-Anne-des-Pays-Bas',
      'voting-venue-addr':      '655 rue Priestman St, Fredericton, N.-B.',
      'voting-callout':         'Chaque vote compte. Que vous votiez tôt, par correspondance ou le jour des élections — <strong>11 mai 2026</strong> — votre voix façonne l\'avenir du Quartier 7. Votez Manisha Varma pour une conseillère dévouée, inclusive et de confiance.',
      'voting-map-title':       'Emplacement du bureau de vote par anticipation',
      'voting-map-sub':         'Paroisse Ste-Anne-des-Pays-Bas<br/>655 rue Priestman St, Fredericton, N.-B.',
      'voting-map-btn':         'Ouvrir dans Google Maps',
      'voting-eday-title':      'Jour des élections',
      'voting-eday-date':       'Lundi 11 mai 2026',
      'voting-eday-sub':        'Bureaux de vote ordinaires ouverts',
      'voting-eday-find':       'Vous ne savez pas où voter?',
      'voting-eday-find-sub':   'Visitez electionsnb.ca pour trouver votre bureau de vote',
    }
  };
