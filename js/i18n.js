...
(function () {
  ...
  var translations = {
    en: {
      ...
      /* Donate page */
      'donate-eyebrow':         'Support the Campaign',
      'donate-title':           'Donate',
      'donate-subtitle':        'Every contribution helps bring Ward 7 a stronger voice.',
      'donate-letter-heading':  'A Message from Manisha',
      'donate-letter-p1':       'A few people have asked how they can support my campaign — I\'m grateful for every offer.',
      'donate-letter-p2':       'For transparency: I\'ve set up an official account at <strong>manisha4ward7@gmail.com</strong> following all Elections NB rules. If you wish to donate, you can e-transfer there. Please include your name + address. Only individuals can contribute.',
      'donate-letter-p3':       'Thank you for being part of this campaign, however you choose to support.',
      'donate-letter-sign':     '— Manisha',
      'donate-how-title':       'How to Donate',
      'donate-step1-label':     'Send an Interac e-Transfer to:',
      'donate-step2-label':     'Include in your memo:',
      'donate-step2-detail':    'Your full name and mailing address',
      'donate-step3-label':     'Important:',
      'donate-step3-detail':    'Only individuals may contribute. Corporate and union donations are not permitted under Elections NB rules.',
      'donate-legal-note':      'All contributions are processed in accordance with Elections NB campaign finance regulations.',
      /* Newsletter */
    ...
    fr: {
      ...
      /* Donate page */
      'donate-eyebrow':         'Soutenir la campagne',
      'donate-title':           'Faire un don',
      'donate-subtitle':        'Chaque contribution aide à donner une voix plus forte au Quartier 7.',
      'donate-letter-heading':  'Un message de Manisha',
      'donate-letter-p1':       'Quelques personnes m\'ont demandé comment elles pouvaient soutenir ma campagne — je suis reconnaissante pour chaque offre.',
      'donate-letter-p2':       'Par souci de transparence : j\'ai créé un compte officiel à <strong>manisha4ward7@gmail.com</strong> conformément à toutes les règles d\'Élections N.-B. Si vous souhaitez faire un don, vous pouvez m\'envoyer un virement électronique à cette adresse. Veuillez inclure votre nom et adresse postale. Seuls les particuliers peuvent contribuer.',
      'donate-letter-p3':       'Merci de faire partie de cette campagne, quelle que soit votre façon de soutenir.',
      'donate-letter-sign':     '— Manisha',
      'donate-how-title':       'Comment faire un don',
      'donate-step1-label':     'Envoyez un virement électronique Interac à :',
      'donate-step2-label':     'Incluez dans votre mémo :',
      'donate-step2-detail':    'Votre nom complet et votre adresse postale',
      'donate-step3-label':     'Important :',
      'donate-step3-detail':    'Seuls les particuliers peuvent contribuer. Les dons d\'entreprises et de syndicats ne sont pas permis selon les règles d\'Élections N.-B.',
      'donate-legal-note':      'Toutes les contributions sont traitées conformément aux règlements sur le financement des campagnes d\'Élections N.-B.',
      /* Newsletter */
